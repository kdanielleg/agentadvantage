...
$sitemapTabsShortcode = do_shortcode('[fusion_tabs design="clean" layout="horizontal" justified="yes" backgroundcolor="" inactivecolor="" bordercolor="" icon="link fal" icon_position="" icon_size="" hide_on_mobile="small-visibility,medium-visibility,large-visibility" class="" id="arListings-detailsTabs"][fusion_tab title="Pages" icon=""]<h2>Pages</h2>[ar_sitemap types="page" show_label="false"][/fusion_tab][fusion_tab title="Areas" icon=""]<h2>Market Areas</h2>[ar_sitemap types="avada_portfolio" show_label="false"][/fusion_tab][fusion_tab title="Blog" icon=""]<h2>Blog Posts</h2>[ar_sitemap types="post" show_label="false"][/fusion_tab][fusion_tab title="Search" icon=""]<h2>Real Estate Search</h2>[ar_sitemap types="idx_page" show_label="false"][/fusion_tab][fusion_tab title="Properties" icon=""]<h2>Properties</h2><div id="arSitemap-propsTab"></div>[/fusion_tab][/fusion_tabs]');
