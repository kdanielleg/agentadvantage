...
$cformTitle = 'Got Questions? Ask Them Here!';
$cformText = 'Fill out the form below and get the help you need with your real estate plans.';
		...
		if($('.IDX-page-moreinfo').length > 0) {
			...
			**/
			...
			if($('div#IDX-contactAddress').length > 0) {
				...
				$('div#IDX-contactInformation').append('<img width="300" height="200" src="https://maps.googleapis.com/maps/api/staticmap?key='+mapKey+'&language=en&center='+map+'&maptype=roadmap&zoom=16&size=300x200&markers=icon:'+mapIcon+'|'+map+'&scale=2" />');
			}
		}
