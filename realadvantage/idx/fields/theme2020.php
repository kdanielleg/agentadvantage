...
function wc_fields_theme2020() {
	...
	$wc_theme2020_results = array(
		array(
			'key' => 'field_6087bdd8cf456results',
			'label' => 'Show Empty Details?',
			'name' => 'results_empty_details',
			'type' => 'true_false',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	/**Other Pages **/
	$wc_theme2020_other = array(
		array(
			'key' => 'field_5e056c36bf8cc2020othertitle',
			...
			'sub_fields' => array(
				array(
					'key' => 'field_5e056cb1bf8ce2020othertitle',
				...
				array(
					'key' => 'field_5e056cc7bf8cf2020othersub',
		...
		array(
			...
			'collapsed' => 'field_5e017ece0eaa22020',
			'min' => 0,
			'max' => 0,
			'layout' => 'table',
			'button_label' => '',
	...
	/**Listings Pages**/
	$wc_theme2020_listing = array(
		array(
			'key' => 'field_5e056c36bf8cc2020title',
			'label' => 'Title Settings',
			'name' => 'listingTitle',
			'type' => 'group',
			'instructions' => '',
			...
			'sub_fields' => array(
				array(
					'key' => 'field_5e056cb1bf8ce2020title',
					'label' => 'Title Selector',
					'name' => 'title',
					'type' => 'text',
					'instructions' => '',
				...
				array(
					'key' => 'field_5e056cc7bf8cf2020sub',
					'label' => 'Subtitle Selector',
					'name' => 'sub',
					'type' => 'text',
					'instructions' => '',
		...
		array(
			...
			'sub_fields' => array(
				array(
					...
					'default_value' => 'Calculate Your Mortgage...',
					'placeholder' => '',
					'prepend' => '',
					'append' => '',
					'maxlength' => '',
				...
				array(
					...
					'default_value' => 'Use the form below to estimate your mortgage payment and help determine what you can afford. Remember that this is only an estimate and your actual monthly payments will include other fees such as insurance and utilities.',
					'placeholder' => '',
					'prepend' => '',
					'append' => '',
					'maxlength' => '',
		...
		array(
			'key' => 'field_5e011eddc7d4b2020mcalcbg',
			'label' => 'Background Image',
			'name' => 'mcalc_bg',
			'type' => 'image',
			'instructions' => '',
	...
	$wc_theme2020_contact = array(
		array(
			'key' => 'field_5e056c36bf8cc2020ctitle',
			'label' => 'Title Settings',
			'name' => 'contactTitle',
			'type' => 'group',
			'instructions' => '',
			...
			'sub_fields' => array(
				array(
					'key' => 'field_5e056cb1bf8ce2020ctitle',
					'label' => 'Title Selector',
					'name' => 'title',
					'type' => 'text',
					'instructions' => '',
				...
				array(
					'key' => 'field_5e056cc7bf8cf2020csub',
					'label' => 'Subtitle Selector',
					'name' => 'sub',
					'type' => 'text',
					'instructions' => '',
		...
		array(
			...
			'sub_fields' => array(
				array(
					...
					'default_value' => 'Ready to Answer Your Questions!',
					'placeholder' => '',
					'prepend' => '',
					'append' => '',
					'maxlength' => '',
	...
	$wc_theme2020_sections = array(
		...
		'other' => array(
			'key' => 'field_5e017e9e0eaa02020',
			'label' => 'Other',
			'fields' => $wc_theme2020_other,
		),
		'listing' => array(
			'key' =>  'field_5e056c20bf8cb2020',
			'label' => 'Listing',
			'fields' => $wc_theme2020_listing,
		),
		'contact' => array(
		...
		'results' => array(
			'key' =>  'field_5e056c20bf8cb2020results',
			'label' => 'Results',
			'fields' => $wc_theme2020_results,
		),
	);
	$wc_theme2020 = array(
