<?php //review stars for builder ?>

<script type="text/template" id="fusion-builder-block-module-privacy-preview-template">
	<h4 class="fusion_module_title"><span class="fusion-module-icon {{ fusionAllElements[element_type].icon }}"></span>{{ fusionAllElements[element_type].name }}</h4>
	<div class="ar-privacy-policy" style="text-align:left;">
		<p>This privacy notice discloses the privacy practices for {{params.website}}. This privacy notice applies solely to information collected by this website. It will notify you of the following:</p>
		...
		<p>If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at {{params.phone}} or via {{params.email}}.</p>
	</div>
</script>