	...
	<?php while ( have_posts() ) : ?>
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'post' ); ?>>
			...
			<div class="post-content">
				<?php if(get_field('content_location')!='below'):
					the_content(); 
				endif;
				include get_stylesheet_directory().'/realadvantage/idx/themes/'.get_field('theme').'.php';
				if(get_field('content_location')=='below'):
					the_content(); 
				endif; ?>
